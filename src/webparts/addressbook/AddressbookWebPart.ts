...
import { ContactCRUDProps } from './interfaces/interfaces';
...
export default class AddressbookWebPart extends BaseClientSideWebPart<IAddressbookWebPartProps> {
  ...
  public render(): void {
    ...
    const element: React.ReactElement<ContactCRUDProps> = React.createElement(
      Addressbook, { context: this.context }
    );
